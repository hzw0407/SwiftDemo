...
public class ShineBaseChart: UIView {
    ...
    func createShaft()  {
        ...
        xshaftLayer.lineCap = CAShapeLayerLineCap.butt
        ...
        yShaftLayer.lineCap = CAShapeLayerLineCap.butt
    ...
    func createShaftArraw(xStart : CGFloat,xRectY : CGFloat,yRectx : CGFloat,yStart: CGFloat)  {
        ...
        xarrawLayer.lineCap = CAShapeLayerLineCap.butt
        ...
        yarrawLayer.lineCap = CAShapeLayerLineCap.butt
