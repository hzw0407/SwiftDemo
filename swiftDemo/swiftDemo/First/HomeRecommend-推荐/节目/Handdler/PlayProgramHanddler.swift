...
// 播放页接口
let PlayProvider = MoyaProvider<PlayProgramHanddler>()

enum PlayProgramHanddler {
    case PlayData(albumId:Int,trackUid:Int, uid:Int)
}

extension PlayProgramHanddler: TargetType {
    //服务器地址
    ...
    var path: String {
        switch self {
        case .PlayData(let albumId, let trackUid, let uid):
