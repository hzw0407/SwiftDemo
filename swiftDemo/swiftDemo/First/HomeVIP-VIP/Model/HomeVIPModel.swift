...
struct HomeVIPModel: HandyJSON {
    var msg: String?
    var ret: Int = 0
    var focusImages: HomeVIPBannerListModel?
    var serverMilliseconds: Int = 0
    var categoryContents: CategoryModel?
}

struct HomeVIPBannerListModel: HandyJSON {
    var data:[HomeVIPBannerModel]?
    var responseId: Int = 0
    var ret: Int = 0
}

//滚动图片
struct HomeVIPBannerModel: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
//分类详情
struct CategoryDetailModel: HandyJSON {
...
//分类按钮
struct CategoryButtonnModel: HandyJSON {
