...
let ClassifySubMenuProvider = MoyaProvider<ClassifySubHanddler>()
//请求分类
public enum ClassifySubHanddler {
...
extension ClassifySubHanddler: TargetType {
    //服务器地址
